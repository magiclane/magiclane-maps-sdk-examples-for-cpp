...
set(ZLIB_STATIC_LIB "${CMAKE_CURRENT_LIST_DIR}/prebuilt/lib/Release/${ARCH_SUBDIR}/zlib.lib")
if(NOT EXISTS "${ZLIB_STATIC_LIB}")
    message(FATAL_ERROR "zlib.lib not found at: ${ZLIB_STATIC_LIB}")
endif()

message(STATUS "Using static zlib for ${VCPKG_TARGET_ARCHITECTURE}: ${ZLIB_STATIC_LIB}")
...
vcpkg_cmake_configure(
    ...
    OPTIONS
		...
		"-DZLIB_INCLUDE_DIR=${CMAKE_CURRENT_LIST_DIR}/prebuilt/include"
)
