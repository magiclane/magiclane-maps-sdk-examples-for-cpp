...
int main(int argc, char** argv)
{
        ...
        std::string input = R"(
    {
      ...
      "orders": [
        ...
        {"alias": "Customer 11", "location": [48.882213, 2.331512], "type":0,"numberOfPackages":5,"weight":9.2,"cube":1.1,"timeWindow":[570,930],"serviceTime":5,"revenue":11,"priority":0},
        {"alias": "Customer 12", "location": [48.854327, 2.362874], "type":1,"numberOfPackages":7,"weight":13.1,"cube":1.3,"timeWindow":[630,990],"serviceTime":5,"revenue":10,"priority":0},
        {"alias": "Customer 13", "location": [48.881954, 2.293521], "type":1,"numberOfPackages":6,"weight":11.0,"cube":1.2,"timeWindow":[690,1050],"serviceTime":5,"revenue":9,"priority":0},
        {"alias": "Customer 14", "location": [48.889213, 2.312349], "type":0,"numberOfPackages":4,"weight":6.7,"cube":0.8,"timeWindow":[750,1110],"serviceTime":5,"revenue":6,"priority":0},
        {"alias": "Customer 15", "location": [48.874211, 2.303412], "type":1,"numberOfPackages":8,"weight":13.5,"cube":1.4,"timeWindow":[810,1170],"serviceTime":5,"revenue":7,"priority":0},
        {"alias": "Customer 16", "location": [48.868492, 2.343152], "type":0,"numberOfPackages":3,"weight":4.3,"cube":0.6,"timeWindow":[930,1290],"serviceTime":5,"revenue":4,"priority":0},
        {"alias": "Customer 17", "location": [48.872156, 2.326891], "type":1,"numberOfPackages":2,"weight":3.1,"cube":0.5,"timeWindow":[990,1350],"serviceTime":5,"revenue":3,"priority":0}
      ],
      "departures": [
         {"alias": "Depot 1", "location": [48.863247, 2.387459]}
        ],
      "destinations": [
         {"alias": "Destination 1", "location": [48.825789, 2.335147]}
        ],
      "vehicles": [
        {"name": "Car vehicle 1", "type":0,"maxLoadWeight":300,"maxLoadCube":50,"startTime":420,"endTime":1439,"licensePlate":"AA-123-AA","consumption":6.5}
      ],
      "vehiclesConstraints": [
