...
- Perform a stateless optimization using a single JSON input that contains all the configuration parameters, orders, vehicles, and constraints for multiple vehicles with 30 orders.
