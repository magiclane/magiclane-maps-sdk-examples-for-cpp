...
- Perform a stateless optimization using a single JSON input with predefined distance and time matrices set (using precalculated matrices instead of real-time calculation).
