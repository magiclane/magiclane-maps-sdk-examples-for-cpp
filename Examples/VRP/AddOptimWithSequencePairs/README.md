...
- Add an optimization with sequence pairs (pick up - delivery order pairs) and display the solution on the map.

Create an optimization where the pieces must be pick-up from one order and delivered to another.
