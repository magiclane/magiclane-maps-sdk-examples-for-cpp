...
int main( int argc, char** argv )
{
...

    {
        ...
        vehicle1.setStartTime(420); //7:00 AM in minutes
        vehicle1.setEndTime(1800);   //6:00 AM next day, in minutes
        ...
        vehicle2.setStartTime(420); //7:00 AM in minutes
        ...
        auto oglContext = session.produceOpenGLContext(Environment::WindowFrameworks::Available, "AddOptimizationWithMultipleVehiclesSingleVehicleContraints");
