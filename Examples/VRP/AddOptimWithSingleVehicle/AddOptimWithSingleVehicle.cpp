...
int main( int argc, char** argv )
{
...

    {
        ...
        //the default values for the Optimization will be used
        //Optimization default values:
        //  - configurationParameters = a ConfigurationParameter object with the default values:
        //      - ignoreTimeWindow = false
        //      - optimizationCriterion = EOptimizationCriterion::OC_Time
        //      - optimizationQuality = EOptimizationQuality::OQ_Optimized
        //      - maxWaitTime = int max
        //      - routeType = ERouteType::RT_Round
        //      - vehicleType = EVehicleType::VT_Car
        //      - distanceUnit = EDistanceUnit::DU_Kilometers
        //      - matrixBuildType = EMatrixBuildType::MBT_Real
        //  - numberOfVehicles = 1
        //  - vehiclesConstraints = a list with only one VehicleContraints object, which has the default values:
        //      - startDate = today
        //      - maxNumberOfPieces = int max
        //      - maxNumberOfOrders = int max
        //      - minNumberOfOrders = 0
        //      - maxDistance = long long max
        //      - minDistance = 0
        //      - maxRevenue = float max
        ...
        auto oglContext = session.produceOpenGLContext(Environment::WindowFrameworks::Available, "AddOptimizationWithSingleVehicle");
