...
int main( int argc, char** argv )
{
	...
	gem::StrongPointer<gem::MapView> mapView = gem::MapView::produce(session.produceOpenGLContext(Environment::WindowFrameworks::Available, "SearchAround", &pTouchEventListener)); 
    if( !mapView )
    {
